...
var UBitsDefinition = &v2.SiteDefinition{
	ID:             "ubits",
	Name:           "UBits",
	Aka:            []string{"UBits", "优比特"},
	Description:    "综合影视 PT 站点",
	Schema:         v2.SchemaNexusPHP,
	URLs:           []string{"https://ubits.club/"},
	FaviconURL:     "https://ubits.club/favicon.ico",
	TimezoneOffset: "+0800",
	RateLimit:      0.5,
	RateBurst:      2,
	...
	Selectors: &v2.SiteSelectors{
		...
		Subtitle:           "table.torrentname td.embedded > span.subtitle",
...
func init() {
	v2.RegisterSiteDefinition(UBitsDefinition)
}
