...
var BaoziDefinition = &v2.SiteDefinition{
	ID:             "baozi",
	Name:           "T-Baozi",
	Aka:            []string{"包子", "Baozi", "T-包子"},
	Description:    "综合性 PT 站点",
	Schema:         v2.SchemaNexusPHP,
	URLs:           []string{"https://p.t-baozi.cc/"},
	FaviconURL:     "https://p.t-baozi.cc/favicon.ico",
	...
	UserInfo: &v2.UserInfoConfig{
		...
		Process: []v2.UserInfoProcess{
			...
			},
			{
				...
				Fields:        []string{"uploaded", "downloaded", "levelName", "joinTime", "lastAccessAt"},
			},
		},
		Selectors: map[string]v2.FieldSelector{
			...
			"bonus": {
				...
				Attr:     "html",
				Filters: []v2.Filter{
					{Name: "regex", Args: []any{`魔力值\s*[：:]\s*</span>\s*</a>\s*([\d.,]+)`}},
					{Name: "parseNumber"},
				},
			},
			"uploaded": {
	...
	Selectors: &v2.SiteSelectors{
		...
		DiscountIcon:       "img.pro_free, img.pro_free2, img.pro_free2up, img.pro_50pctdown, img.pro_30pctdown, img.pro_2up, img.pro_50pctdown2up",
...
func init() {
	v2.RegisterSiteDefinition(BaoziDefinition)
}
