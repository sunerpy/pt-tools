...
var BTSchoolDefinition = &v2.SiteDefinition{
	...
	RateBurst:       2,
	HREnabled:       true,
	HRSeedTimeHours: 20, // 10天窗口内做种20小时；分享率>1免除
	...
	LevelRequirements: btschoolLevelRequirements,
}

var btschoolLevelRequirements = []v2.SiteLevelRequirement{
	{ID: 1, Name: "User"},
	{ID: 2, Name: "Power User", Interval: "P4W", Downloaded: "50GB", Ratio: 2.0, SeedingBonus: 40000},
	{ID: 3, Name: "Elite User", Interval: "P8W", Downloaded: "100GB", Ratio: 2.5, SeedingBonus: 80000},
	{ID: 4, Name: "Crazy User", Interval: "P15W", Downloaded: "300GB", Ratio: 3.0, SeedingBonus: 150000},
	{ID: 5, Name: "Insane User", Interval: "P25W", Downloaded: "500GB", Ratio: 3.5, SeedingBonus: 250000},
	{ID: 6, Name: "Veteran User", Interval: "P40W", Downloaded: "1TB", Ratio: 4.0, SeedingBonus: 400000},
	{ID: 7, Name: "Extreme User", Interval: "P60W", Downloaded: "2TB", Ratio: 4.5, SeedingBonus: 600000},
	{ID: 8, Name: "Ultimate User", Interval: "P80W", Downloaded: "5TB", Ratio: 5.0, SeedingBonus: 800000},
	{ID: 9, Name: "Nexus Master", Interval: "P100W", Downloaded: "10TB", Ratio: 5.5, SeedingBonus: 1000000},
}

func init() {
	v2.RegisterSiteDefinition(BTSchoolDefinition)
}
