...
var PTLoverDefinition = &v2.SiteDefinition{
	ID:             "ptlover",
	Name:           "PTLover",
	Aka:            []string{"AFUN", "PT Lover"},
	Description:    "PTLover 综合资源站",
	Schema:         v2.SchemaNexusPHP,
	URLs:           []string{"https://www.ptlover.cc/"},
	FaviconURL:     "https://www.ptlover.cc/favicon.ico",
	...
	UserInfo: &v2.UserInfoConfig{
		...
		Selectors: map[string]v2.FieldSelector{
			...
			"bonus": {Selector: []string{"td.rowhead:contains('喵饼') + td"}, Filters: []v2.Filter{{Name: "parseNumber"}}},
			"joinTime": {
...
func init() {
	v2.RegisterSiteDefinition(PTLoverDefinition)
}
