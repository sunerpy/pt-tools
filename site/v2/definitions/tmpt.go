...
var TMPTDefinition = &v2.SiteDefinition{
	ID:             "tmpt",
	Name:           "TMPT",
	Aka:            []string{"TMPT", "唐门"},
	Description:    "唐门影视 PT 站点",
	Schema:         v2.SchemaNexusPHP,
	URLs:           []string{"https://tmpt.top/"},
	FaviconURL:     "https://tmpt.top/favicon.ico",
	TimezoneOffset: "+0800",
	RateLimit:      0.5,
	RateBurst:      2,
...
func init() {
	v2.RegisterSiteDefinition(TMPTDefinition)
}
