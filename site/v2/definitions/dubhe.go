...
var DubheDefinition = &v2.SiteDefinition{
	ID:             "dubhe",
	Name:           "Dubhe",
	Aka:            []string{"天枢", "北斗第一星"},
	Description:    "天枢 — 综合性 NexusPHP PT 站点（dubhe.site）",
	Schema:         v2.SchemaNexusPHP,
	URLs:           []string{"https://dubhe.site/"},
	FaviconURL:     "https://dubhe.site/favicon.ico",
	TimezoneOffset: "+0800",
	RateLimit:      0.5,
	RateBurst:      2,
...
func init() {
	v2.RegisterSiteDefinition(DubheDefinition)
}
