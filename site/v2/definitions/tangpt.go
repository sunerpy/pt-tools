...
// TangPTDefinition 适配 www.tangpt.top（NexusPHP，CHD scenetorrents 模板，Cookie 认证）。
var TangPTDefinition = &v2.SiteDefinition{
	ID:             "tangpt",
	Name:           "TangPT",
	Aka:            []string{"糖果", "TPT"},
	Description:    "综合性 PT 站点",
	Schema:         v2.SchemaNexusPHP,
	URLs:           []string{"https://www.tangpt.top/"},
	FaviconURL:     "https://www.tangpt.top/favicon.ico",
...
func init() {
	v2.RegisterSiteDefinition(TangPTDefinition)
}
