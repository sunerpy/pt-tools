...
var MyPTCCDefinition = &v2.SiteDefinition{
	ID:              "myptcc",
	Name:            "MyPTCC",
	Aka:             []string{"我的PT", "cc.mypt.cc"},
	Description:     "我的PT(CC) 人类资源库",
	Schema:          v2.SchemaNexusPHP,
	URLs:            []string{"https://cc.mypt.cc/"},
	FaviconURL:      "https://cc.mypt.cc/favicon.ico",
	...
	UserInfo: &v2.UserInfoConfig{
		...
		Selectors: map[string]v2.FieldSelector{
			...
			"ratio": {
				...
				Attr:     "html",
				Filters:  []v2.Filter{{Name: "regex", Args: []any{`(?:分享率|Ratio)(?:</strong>)?[：:\s]*(?:<font[^>]*>)?([\d.,]+|∞|Inf)`}}, {Name: "parseNumber"}},
			},
			"levelName": {
			...
			"bonus": {
				Selector: []string{"#info_block", "td.rowhead:contains('魔力值') + td"},
				Attr:     "html",
...
func init() {
	v2.RegisterSiteDefinition(MyPTCCDefinition)
}
