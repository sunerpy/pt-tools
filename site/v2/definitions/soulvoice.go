...
var SoulVoiceDefinition = &v2.SiteDefinition{
	ID:              "soulvoice",
	Name:            "SoulVoice",
	Aka:             []string{"聆音"},
	Description:     "致力于建设一个有声资源，电子书为主，学习资料，影视资源为辅的PT分享站",
	Schema:          v2.SchemaNexusPHP,
	URLs:            []string{"https://pt.soulvoice.club/"},
	FaviconURL:      "https://pt.soulvoice.club/favicon.ico",
	AuthMethod:      v2.AuthMethodCookie,
	TimezoneOffset:  "+0800",
	RateLimit:       0.5,
	RateBurst:       2,
	HREnabled:       true,
	HRSeedTimeHours: 72, // 30天窗口内做种72小时；上传量>2倍下载量免除
	...
	LevelRequirements: soulvoiceLevelRequirements,
}

var soulvoiceLevelRequirements = []v2.SiteLevelRequirement{
	{ID: 1, Name: "Peasant", Privilege: "降级用户"},
	{ID: 2, Name: "User"},
	{ID: 3, Name: "Power User", Interval: "P4W", Downloaded: "50GB", Ratio: 1.05},
	{ID: 4, Name: "Elite User", Interval: "P8W", Downloaded: "120GB", Ratio: 1.55},
	{ID: 5, Name: "Crazy User", Interval: "P15W", Downloaded: "300GB", Ratio: 2.05},
	{ID: 6, Name: "Insane User", Interval: "P25W", Downloaded: "500GB", Ratio: 2.55},
	{ID: 7, Name: "Veteran User", Interval: "P40W", Downloaded: "750GB", Ratio: 3.05},
	{ID: 8, Name: "Extreme User", Interval: "P60W", Downloaded: "1TB", Ratio: 3.55},
	{ID: 9, Name: "Ultimate User", Interval: "P80W", Downloaded: "1.5TB", Ratio: 4.05},
	{ID: 10, Name: "Nexus Master", Interval: "P100W", Downloaded: "3TB", Ratio: 4.55},
}

func init() {
	v2.RegisterSiteDefinition(SoulVoiceDefinition)
}
