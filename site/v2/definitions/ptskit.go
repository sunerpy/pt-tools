...
var PTSKITDefinition = &v2.SiteDefinition{
	ID:             "ptskit",
	Name:           "PTSKIT",
	Aka:            []string{"拾刻"},
	Description:    "以短剧与影视资源为主的 NexusPHP PT 站点",
	Schema:         v2.SchemaNexusPHP,
	URLs:           []string{"https://www.ptskit.org/"},
	FaviconURL:     "https://www.ptskit.org/favicon.ico",
	TimezoneOffset: "+0800",
	RateLimit:      0.5,
	RateBurst:      2,
...
func init() {
	v2.RegisterSiteDefinition(PTSKITDefinition)
}
