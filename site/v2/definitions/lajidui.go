...
var LajiduiDefinition = &v2.SiteDefinition{
	ID:             "lajidui",
	Name:           "lajidui",
	Aka:            []string{"垃圾堆"},
	Description:    "极致文件共享体验",
	Schema:         v2.SchemaNexusPHP,
	URLs:           []string{"https://pt.lajidui.top/"},
	FaviconURL:     "https://pt.lajidui.top/favicon.ico",
	TimezoneOffset: "+0800",
	RateLimit:      0.5,
	RateBurst:      2,
	UserInfo: &v2.UserInfoConfig{
		...
		Selectors: map[string]v2.FieldSelector{
			...
			"ratio": {
				Selector: []string{"td.rowhead:contains('传输') + td", "td.rowhead:contains('傳輸') + td", "td.rowhead:contains('Transfer') + td", "td.rowhead:contains('分享率') + td font", "td.rowhead:contains('分享率') + td", "td.rowhead:contains('Ratio') + td font", "td.rowhead:contains('Ratio') + td", "#info_block"},
				Attr:     "html",
				Filters: []v2.Filter{
	...
	LevelRequirements: lajiduiLevelRequirements,
}

var lajiduiLevelRequirements = []v2.SiteLevelRequirement{
	...
	{ID: 5, Name: "Insane User", NameAka: []string{"变态用户"}, Interval: "P25W", Downloaded: "500GB", Ratio: 2.55},
	{ID: 6, Name: "Veteran User", NameAka: []string{"资深用户"}, Interval: "P40W", Downloaded: "750GB", Ratio: 3.05},
	{ID: 7, Name: "Extreme User", NameAka: []string{"极限用户"}, Interval: "P60W", Downloaded: "1TB", Ratio: 3.55},
	{ID: 8, Name: "Ultimate User", NameAka: []string{"终极用户"}, Interval: "P80W", Downloaded: "1.5TB", Ratio: 4.05},
	{ID: 9, Name: "Nexus Master", NameAka: []string{"大师"}, Interval: "P100W", Downloaded: "3TB", Ratio: 4.55},
}

func init() {
	v2.RegisterSiteDefinition(LajiduiDefinition)
}
