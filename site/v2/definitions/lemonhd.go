...
var LemonHDDefinition = &v2.SiteDefinition{
	ID:             "lemonhd",
	Name:           "LemonHD",
	Aka:            []string{"Lemon"},
	Description:    "LemonHD 综合影视 PT 站点",
	Schema:         v2.SchemaNexusPHP,
	URLs:           []string{"https://lemonhd.net/"},
	FaviconURL:     "https://lemonhd.net/favicon.ico",
	...
	UserInfo: &v2.UserInfoConfig{
		...
		Selectors: map[string]v2.FieldSelector{
			"id": {
				Selector: []string{"a[href*='userdetails.php'][class*='Name']", "span.nowrap a[href*='userdetails.php']", "a[href*='userdetails.php']"},
				Attr:     "href",
				Filters:  []v2.Filter{{Name: "querystring", Args: []any{"id"}}},
			},
			"name": {
				Selector: []string{"a[href*='userdetails.php'][class*='Name']", "span.nowrap a[href*='userdetails.php']"},
			},
			"uploaded": {
				Selector: []string{"td.rowhead:contains('传输') + td", ".bottom .medium", "body"},
				Attr:     "html",
				Filters: []v2.Filter{
			...
			"bonus": {
				Selector: []string{"td.rowhead:contains('魔力值') + td", ".bottom .medium", "body"},
				Attr:     "html",
				Filters: []v2.Filter{
			...
			"seeding": {
				Selector: []string{".bottom .medium", "body"},
				Attr:     "html",
				Filters: []v2.Filter{
...
func init() {
	v2.RegisterSiteDefinition(LemonHDDefinition)
}
