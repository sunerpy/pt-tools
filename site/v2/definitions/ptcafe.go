...
var PTCafeDefinition = &v2.SiteDefinition{
	ID:             "ptcafe",
	Name:           "PTCafe",
	Aka:            []string{"咖啡", "咖啡PT"},
	Description:    "咖啡 — 综合性 NexusPHP PT 站点（ptcafe.club）",
	Schema:         v2.SchemaNexusPHP,
	URLs:           []string{"https://ptcafe.club/"},
	FaviconURL:     "https://ptcafe.club/favicon.ico",
	TimezoneOffset: "+0800",
	RateLimit:      0.5,
	RateBurst:      2,
...
func init() {
	v2.RegisterSiteDefinition(PTCafeDefinition)
}
