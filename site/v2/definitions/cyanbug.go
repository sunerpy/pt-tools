...
var CyanBugDefinition = &v2.SiteDefinition{
	ID:             "cyanbug",
	Name:           "CyanBug",
	Aka:            []string{"大青虫", "青虫"},
	Description:    "大青虫 — 综合性 NexusPHP PT 站点（cyanbug.net）",
	Schema:         v2.SchemaNexusPHP,
	URLs:           []string{"https://cyanbug.net/"},
	FaviconURL:     "https://cyanbug.net/favicon.ico",
	TimezoneOffset: "+0800",
	RateLimit:      0.5,
	RateBurst:      2,
...
func init() {
	v2.RegisterSiteDefinition(CyanBugDefinition)
}
